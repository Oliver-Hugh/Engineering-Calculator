...
global_w = 1200
global_h = 750
geometry_str = str(global_w) + "x" + str(global_h)
...
instruction_text = "Hello! This is an application meant as a quick reference for designers working with CAD.\n" \
                    "Simply select between the different options for each individual calculator/convertor and \n" \
                    "input data for results! -Oliver Hugh"
